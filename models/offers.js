...
var schema = new mongoose.Schema({
	...
	price	      			: { type: Number, required: false },  // for failing power report & type of emotions
	startdate	     		: { type: Date, required: true },
	enddate 	    		: { type: Date, required: true },
	expiration    			: { type: Date, required: false } // always now
...
module.exports = {
  'Offers': mongoose.model('Offers', schema)
};
